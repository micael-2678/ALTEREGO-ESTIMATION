...
export const ADJUSTMENT_WEIGHTS = {
  ...
  // État intérieur / standing
  condition: 12,             // ±12% max
  
  // DPE (performance énergétique)
  dpe: 10,                   // ±10% max
  
  // Effet de surface (très petit/très grand)
  surface_effect: 8,         // ±8% max
  
  // Parcelle (maison uniquement)
  plot: 10,                  // ±10% max
  
  // Équipements maison (piscine, dépendance)
  house_extras: 6            // ±6% max
};
